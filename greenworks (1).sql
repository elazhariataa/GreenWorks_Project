...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3580627794ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=greenworks&table=greenwork">`greenworks`.`greenwork`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gestion_des_avocats&table=affaire">`gestion_des_avocats`.`affaire`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=greenworks&table=compte">`greenworks`.`compte`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=greenworks&table=client">`greenworks`.`client`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=greenworks&table=avocat">`greenworks`.`avocat`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=greenworks&table=affaire">`greenworks`.`affaire`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=greenworks&table=Compte">`greenworks`.`Compte`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=exercices&table=exercice">`exercices`.`exercice`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gestion_stagiaires&table=stagiaires">`gestion_stagiaires`.`stagiaires`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=users&table=compte">`users`.`compte`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="35534963335855296029323a5a4c4529">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="greenworks" targettable="greenwork">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `greenwork`</span>
                        </div>
